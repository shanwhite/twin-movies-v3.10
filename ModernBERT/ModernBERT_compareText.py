# This script compares a pair of sentences in different languages and calculates the similarity scores using cosine similarity.
...
# ModernBERT embedding
def embed(text):
    # tokenise input text and move tensor to device
    ...
    # mask out padding tokens (spaces after the sentence) before averaging the sum
...
# calculating the similarity scores for each pair of sentences using cosine similarity 
similarities = []
...
# using notched box plots for the resulting similarity scores
plt.boxplot([similarities], notch=True)
plt.ylabel("Cosine Similarity")
plt.title("Chinese-Irish Sentence Similarity (ModernBERT)")
